# -*- coding: utf-8 -*-
"""
Created on Tue Jun 29 19:45:53 2021

@author: Sheela Vatsala
"""

# Multilinear Regression for cars dataset
import pandas as pd
import numpy as np
import pickle
# loading the data
cars = pd.read_csv("C:\\Users\\Sheela Vatsala\\Desktop\\360digitmg\\Studymaterial\\MLR\\cars.csv")
...
pickle.dump(model_train, open('car.pkl', 'wb'))
